...
function IntegrationListPage() {
  ...
  const handleView = (id: string) => {
    if (hasAccess('integration', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)) {
      router.push(`/integrations/view/${id}`);
    }
  };
      ...
      <Box bg="white" p={4} rounded="md" shadow="md">
        {hasAccess('integration', AccessOperationEnum.CREATE, AccessServiceEnum.PROJECT) && (
          <Flex justifyContent="space-between" mb={4}>
            ...
            <NextLink href={`/integrations/create`} passHref legacyBehavior>
